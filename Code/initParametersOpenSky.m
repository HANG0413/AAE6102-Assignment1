...
file.fileRoute      = ['C:\PloyU\DH\Course\Satellite\',file.fileName,'.bin'];  
...
track.msToProcessVT         = 90000; %track.msPosCT - file.skiptimeVT; %
track.pdi                   = 5; %
...
solu.accel_navStateVT = 0; % 0:no accelerations as navigation states; 1:accelerations as navigation states in VTL EKF
...
solu.iniPos = [22.328444770087565, 114.1713630049711 7];
