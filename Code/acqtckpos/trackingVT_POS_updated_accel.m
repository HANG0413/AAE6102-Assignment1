function [TckResultVT, navSolutionsVT] = trackingVT_POS_updated_accel(file,signal,track,cmn,solu,Acquired,cnslxyz,eph,sbf,TckResult_Eph,TckResultCT,navSolutionsCT)
%Purpose:
