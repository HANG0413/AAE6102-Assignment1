...
%% File parameters
file.fileName       = 'Urban';
file.fileRoute      = ['C:\PloyU\DH\Course\Satellite\',file.fileName,'.dat'];  
...
solu.sat_dynamic = 1; % 0: no dynamic model involved; 1: satellite dynamic model aiding in VTL EKF
...
solu.iniPos = [22.3198722, 114.209101777778 3];
